...
## **Dia 3: Integração Frontend e Backend Avançada**

---

## Abertura

Bem-vindos ao último dia do **Workshop: Road to Meridian 2**!

Hoje vamos integrar tudo que aprendemos nos dias anteriores e criar uma aplicação completa. Vamos desenvolver tanto o frontend quanto o backend, integrando com smart contracts Stellar e criando uma experiência de usuário completa.

Preparados para criar uma DApp completa do zero?

### Programa da aula:

0. **Quem somos e o que é o Road to Meridian?**
1. Integração Frontend: Wallet, Contas e Contratos
2. Backend Robusto: Python SDK e Operações em Lote
3. Integração Completa: API REST e Comunicação
4. Deploy e Monitoramento: Produção e Melhores Práticas
