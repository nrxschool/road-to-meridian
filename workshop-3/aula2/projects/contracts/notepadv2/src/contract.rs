...
#[contractimpl]
impl Notepad {
    pub fn add_note(env: Env, caller: Address, note: String) -> u32 {
...
#[contractimpl]
impl Notepad {
    pub fn add_note_contract(env: Env, contract: Address, caller: Address, note: String) -> u32 {
        v2::add_note_contract(&env, contract, caller, note)
    }

    pub fn get_note_contract(env: Env, contract: Address, counter: u32) -> String {
        v2::get_note_contract(&env, contract, counter)
    }
}
